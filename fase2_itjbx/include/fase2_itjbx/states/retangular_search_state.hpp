...
public:
    ...
    void on_enter(fsm::Blackboard &blackboard) override {
        ...
        // A blackboard so tem float (todo parametro numerico do YAML e
        // convertido em Fase2ItjbxFSM antes de ser gravado). Le-se como
        // float e converte-se para int aqui, uma unica vez.
        ...
        // Ponteiro pego uma unica vez: "bases" so e mutada por cima do mesmo
        // objeto depois disso (nunca reescrita via blackboard_set), entao o
        // ponteiro continua valido pelo resto da vida da FSM. Ver o
        // comentario no construtor de Fase2ItjbxFSM.
