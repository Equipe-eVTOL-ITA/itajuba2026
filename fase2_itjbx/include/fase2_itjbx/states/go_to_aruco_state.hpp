...
/**
 * Portado de sae2026/mission_1 (GoToArucoState) sem alteracoes de logica —
 * PD visual servo sobre o erro normalizado de ArUco (aruco_x_error/y_error),
 * com predicao cinematica durante perdas curtas de deteccao.
 */
...
private:
    ...
    static constexpr int max_misses_ = 30;  // 1.5s at 20Hz — allows for inertia settling after search
};
